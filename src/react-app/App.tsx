...
function App() {
    return (
        <div className='min-h-screen flex flex-col font-sans selection:bg-brand-orange selection:text-white'>
            {/* Navigation */}
            <nav className='bg-white border-b border-brand-sand/20 px-6 py-4'>
                <div className='max-w-7xl mx-auto flex justify-between items-center'>
                    ...
                    />
                    <button className='bg-brand-orange text-white px-6 py-2 rounded font-bold hover:bg-brand-rust transition-colors shadow-lg'>
                        Join the Fight
                    </button>
                </div>
            </nav>
